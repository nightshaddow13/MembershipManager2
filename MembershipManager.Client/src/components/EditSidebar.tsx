		...
		<ApiContext.Provider value={client}>
			...
			>
				<SheetContent className="w-screen xl:max-w-3xl md:max-w-xl max-w-lg">
					...
					<SheetFooter>
						<div className="w-full absolute bottom-0 left-0 border-gray-200 dark:border-gray-700 border-t mt-4 px-4 py-3 bg-gray-50 dark:bg-gray-900 sm:px-6 flex flex-wrap justify-between">
							<div>
