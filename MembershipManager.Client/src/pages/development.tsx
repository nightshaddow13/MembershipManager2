	...
	return (
		<Layout title="React SPA with Vite + TypeScript">
			<div className="mx-auto mt-16 max-w-7xl px-4 sm:mt-24">
				<div className="text-center">
					<h1 className="text-4xl font-bold tracking-tight text-gray-900 dark:text-gray-100 sm:text-5xl md:text-6xl">
						...
						<span className="block text-link-dark dark:text-link-dark xl:inline">
							React SPA
						</span>
					</h1>
					...
					<section>
						<div className="mb-8 md:mb-16">
							<div className="sm:mx-0">
								<Link
									aria-label={primaryPost.title}
									to={postLink(primaryPost)}
								>
									<img
										src={primaryPost.image}
										alt={`Cover Image for ${primaryPost.title}`}
						...
						<div className="md:grid md:grid-cols-2 md:gap-x-16 lg:gap-x-8 mb-20 md:mb-28">
							<div>
								...
								<div className="mb-4 md:mb-0 text-lg">
									<time dateTime={dateTimestamp(primaryPost.date)}>
										{dateLabel(primaryPost.date)}
									</time>
								</div>
							</div>
							<div>
								...
								{authorLink(primaryPost.author) ? (
									...
									>
										<img
											src={authorProfileUrl(primaryPost.author)}
			...
			<div className="flex justify-center my-20 py-20 bg-slate-100 dark:bg-slate-800">
				<div className="text-center">
					<Icon
						...
						className="text-link-dark w-36 h-36 inline-block"
					/>
			...
			<div className="text-center text-xl">
				Opinionated React template for a productive out-of-the-box development
				UX
			</div>
