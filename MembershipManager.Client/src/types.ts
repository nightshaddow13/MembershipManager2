...
export type GridShowOptions =
	...
	| "newItem";
/* MarkdownInput */
export type MarkdownInputOptions =
	| "bold"
	| "italics"
	| "link"
	| "image"
...
export type ApiState = {
	...
	apiForm: <TResponse>(
		request: ApiRequest | IReturn<TResponse>,
		body: FormData,
		args?: any,
		method?: string
	) => Promise<ApiResult<TResponse>>;
...
export class MetadataApp implements IReturn<AppMetadata> {
	...
	public constructor(init?: Partial<MetadataApp>) {
